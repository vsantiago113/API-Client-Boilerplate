from tests.TestAPIClient import Client
import unittest
import json
...
class TestExampleAPIClient(unittest.TestCase):
    ...
    def test_authentication(self):
        client = Client()
        response = client.connect(username='admin', password='Admin123')
